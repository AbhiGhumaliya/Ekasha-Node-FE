  ...
  return (
    <NotFoundWrapper>
      ...
      <div className="message-box">
        <h1>404</h1>
        <p>Page not found or resource may be broken</p>
        <div className="buttons-con">
          <div id="Reload" className="action-link-wrap">
            <Link to={redirectPath === 'Administration' ? '/zeronsec/administration/SLA' : '/zeronsec'} className="link-button link-back-button">Reload</Link>
          </div>
        </div>
      </div>
    </NotFoundWrapper>
